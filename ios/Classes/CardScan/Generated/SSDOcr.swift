...
@available(macOS 10.13.2, iOS 11.2, tvOS 11.2, watchOS 4.2, visionOS 1.0, *)
class SSDOcrInput : MLFeatureProvider {
    ...
    convenience init(_0With _0: CGImage) throws {
        self.init(_0: try MLFeatureValue(cgImage: _0, pixelsWide: 600, pixelsHigh: 375, pixelFormatType: kCVPixelFormatType_32ARGB, options: nil).imageBufferValue!)
    }

    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, visionOS 1.0, *)
    convenience init(_0At _0: URL) throws {
        self.init(_0: try MLFeatureValue(imageAt: _0, pixelsWide: 600, pixelsHigh: 375, pixelFormatType: kCVPixelFormatType_32ARGB, options: nil).imageBufferValue!)
    }
...
class SSDOcrOutput : MLFeatureProvider {
    ...
    var scores: MLMultiArray {
        provider.featureValue(for: "scores")!.multiArrayValue!
    }

    /// MultiArray of shape (1, 1, 1, 3420, 10). The first and second dimensions correspond to sequence and batch size, respectively as multidimensional array of floats
    @available(macOS 12.0, iOS 15.0, tvOS 15.0, watchOS 8.0, visionOS 1.0, *)
    var scoresShapedArray: MLShapedArray<Float> {
        MLShapedArray<Float>(scores)
    }
    ...
    var boxes: MLMultiArray {
        provider.featureValue(for: "boxes")!.multiArrayValue!
    }

    /// MultiArray of shape (1, 1, 1, 3420, 4). The first and second dimensions correspond to sequence and batch size, respectively as multidimensional array of floats
    @available(macOS 12.0, iOS 15.0, tvOS 15.0, watchOS 8.0, visionOS 1.0, *)
    var boxesShapedArray: MLShapedArray<Float> {
        MLShapedArray<Float>(boxes)
    }
    ...
    var filter: MLMultiArray {
        provider.featureValue(for: "filter")!.multiArrayValue!
    }

    /// MultiArray of shape (1, 1, 1, 3420, 1). The first and second dimensions correspond to sequence and batch size, respectively as multidimensional array of floats
    @available(macOS 12.0, iOS 15.0, tvOS 15.0, watchOS 8.0, visionOS 1.0, *)
    var filterShapedArray: MLShapedArray<Float> {
        MLShapedArray<Float>(filter)
    }
...
class SSDOcr {
    ...
    /// URL of model — prefers fintech_card_core_cardscan resource bundle.
    class var urlOfModelInThisBundle : URL {
        if let url = CSBundle.compiledModel(forResource: "SSDOcr", withExtension: "mlmodelc") {
            return url
        }
    ...
    */
    @available(macOS 12.0, iOS 15.0, tvOS 15.0, watchOS 8.0, visionOS 1.0, *)
    class func load(configuration: MLModelConfiguration = MLModelConfiguration()) async throws -> SSDOcr {
    ...
    */
    @available(macOS 12.0, iOS 15.0, tvOS 15.0, watchOS 8.0, visionOS 1.0, *)
    class func load(contentsOf modelURL: URL, configuration: MLModelConfiguration = MLModelConfiguration()) async throws -> SSDOcr {
    ...
    */
    ...
    func prediction(input: SSDOcrInput, options: MLPredictionOptions = MLPredictionOptions()) async throws -> SSDOcrOutput {
    ...
    /**
        ...
        - parameters:
            - _0: color (kCVPixelFormatType_32BGRA) image buffer, 600 pixels wide by 375 pixels high
